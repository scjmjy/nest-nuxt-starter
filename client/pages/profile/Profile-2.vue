<template>
<main
    class="font-sans antialiased leading-normal tracking-wider bg-cover profile__bg"
    :class="{ 'text-gray-900': !light, 'text-gray-100': light }"
>
    <div class="max-w-4xl flex items-center h-screen flex-wrap mx-auto py-32">
        <!--Main Col-->
        <div
            id="profile"
            class="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl opacity-75 mx-6 lg:mx-0"
            :class="{ 'bg-white': !light, 'bg-gray-900': light }"
        >
            <div class="p-4 md:p-12 text-center lg:text-left">
                ...
                <div class="mt-6 pb-16 lg:pb-0 w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between">
                    ...
                    >
                        ...
                        <path d="M7.5 6.75V0h9v6.75h-9zm9 3.75H24V24H0V10.5h7.5v6.75h9V10.5z" /></svg></a>
                    <a
                        class="link"
                        href="#"
        ...
        <div class="w-full lg:w-2/5">
            ...
            <img
                ...
                src="~/assets/img/avatar-someone.jpg"
            >
...
.profile__bg {
    background-image: url(~/assets/img/bg-profile-2.jpg);
}
.profile__avatar {
    background-image: url(~/assets/img/avatar-someone.jpg);
}
</style>
