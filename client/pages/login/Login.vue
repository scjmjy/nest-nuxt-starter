<template>
<section class="login min-h-screen flex items-stretch text-white">
    <div class="lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center login__bg">
    ...
    <div
        ...
        <div class="absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center login__bg">
            <div class="absolute bg-black opacity-60 inset-0 z-0" />
        </div>
